    ...
    <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <div class="p-3" style="max-width: 900px;">
                        <h4 class="text-white text-uppercase mb-4 animated zoomIn">Ensemble bâtissons une autre Afrique</h4>
                        <h1 class="display-1 text-white mb-0 animated zoomIn">celle de grands défis de la nouvelle économie.</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <div class="p-3" style="max-width: 900px;">
                        <h4 class="text-white text-uppercase mb-4 animated zoomIn">des Data Center de la zone franche</h4>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <div class="p-3" style="max-width: 900px;">
                        <h4 class="text-white text-uppercase mb-4 animated zoomIn">Nous vous invitons donc à un partenariat</h4>
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="h-100">
                    ...
                    <p class="mb-4"> La ZBTIC est un territoire sur lequel s’appliquent des politiques fiscales et douanières avantageuses.</p>
                    <div class="row g-4">
                        <div class="col-12" style="text-align: justify" >

La législation ivoirienne relative à la ZBTIC (loi N° 429-2004 du 30 août 2004) attribue le monopole de la gestion, de l’exploitation, de l’aménagement et de la promotion du Village de l’Innovation Technologique à l’entreprise VITIB S.A.

A son tour, VITIB S.A. a fait concevoir un Plan de Masse conforme à un statut de ville intelligente (smart city).
Ce plan de masse s’appuyant sur un certain nombre d’études menées par des cabinets de renom, prévoit la réalisation d’un certain nombre d’infrastructures.

Dans l’optique d’optimiser ses ressources et se concentrer sur son cœur de métier, à savoir la promotion et l’exploitation de son parc technologique, VITIB souhaite s’entourer de partenaires investisseurs nationaux et internationaux pour le développement de cette « ville intelligente ».
