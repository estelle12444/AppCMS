    ...
    <section>
        ...
        <div class=" pl-16 pb-5 bg-gradient-to-r from-orange-100 from-20%  to-gray-100 to-90%  ">
            <div class="grid gap-8 md:grid-cols-2 md:items-center md:right pt-16 container pb-8">
                <div data-aos="zoom-out-right" data-aos-duration="1500" data-aos-delay="500" class=" lg:pt-12 sm:pl-8 md:pl-8 ">
                ...
                <div data-aos="zoom-out-left" data-aos-duration="1500" data-aos-delay="500" class=" pr-24  bg-no-repeat"
            ...
            <div class="  pl-20 pt-24 sm:pl-2 md:pl-4 pt-8 ">
                <div class=" bg-no-repeat " style="background-image: url(img/background/font_logo.png)">
                    <div data-aos="zoom-in-up" data-aos-duration="1500" data-aos-delay="500"
                        ...
                        <div>
                            <h1 class=" text-center text-3xl font-bold text-slate-600  sm:p-2 lg:p-6">INNOVEZ AU COEUR DE
                                L'AFRIQUE
                            </h1>
                        </div>
                        <div class=" tracking-tight">
                            <p
                                ...
                                développement technologique en Côte D'Ivoire. Situé au coeur de l'Afrique, en Côte d'Ivoire,
                                le
                                VITIB est une zonz franche technologique qui offre un environnement propice à la croissance
                                des
                ...
                <div class="md:flex flex-row pt-16 " style="background-image: url(img/Image8.png)">
                    <div data-aos="fade-right" data-aos-duration="1500" data-aos-delay="500"
                        ...
                        <p class="md:text-center md:text-lg text-justify md:tracking-tight pt-8 md:pr-16">
                            ...
                            En combinant avantages fiscaux, infrastructures modernes, accès à un marché en pleine croissance
                            et
                            soutien gouvernemental,
                            le VITIB se positionne comme un choix stratégique pour les entreprises qui souhaitent prospérer
                            dans
            ...
            <div class="md:pl-32 md:pr-32  bg-no-repeat"
                ...
                <div class="md:pl-24 md:pr-16 px-16 ">
                    <div class="md:flex flex-row  ">
                        ...
                        <div data-aos="zoom-in-left" data-aos-duration="1500" data-aos-delay="500" class="basis-1/2">
                            <div>
                ...
                <div data-aos-anchor-placement="bottom-center"data-aos-duration="1500" data-aos-delay="500"
                    ...
                    <div class="md:pl-64 md:pr-32">
                        <p data-aos="zoom-in-right" data-aos-duration="1500" data-aos-delay="500"
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 pt-16">
                        <div class="ml-10">
                            <img data-aos="zoom-in-left" data-aos-duration="1500" data-aos-delay="500"
                                class="h-auto max-w-full rounded-lg" src="img/Image2.png" alt="">
                        ...
                        <div class="md:ml-10">
                            <img data-aos="zoom-in-left" data-aos-duration="1500" data-aos-delay="500"
                                class="h-auto max-w-full rounded-lg" src="img/Image3.png" alt="">
                            <h2 class="pt-8 text-2xl">
                        ...
                        <div class="ml-10">
                            <img data-aos="zoom-in-right" data-aos-duration="1500" data-aos-delay="500"
                                class="h-auto max-w-full rounded-lg" src="img/Image1.png" alt="">
                            <h2 class="pt-8 text-2xl">
                            ...
                            <p class="text-justify pt-4">
                                ...
                                technologique
                                pour
                                se connecter, partager et apprendre les uns des autres. Posez votre candidature ci-dessous.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div data-aos="zoom-in-up" data-aos-duration="1500" data-aos-delay="500"
                    class="md:flex flex-col bg-repeat-x " style="background-image: url('img/Image6.png')">
                ...
                <div class="md:flex flex-col  pt-20 pb-32">
                    ...
                    <div data-aos="zoom-in-up" data-aos-duration="1500" data-aos-delay="500" class="md:flex flex-row">
                        <div class="md:basis-1/3  ">
                            <div class="md:flex flex-col">
                                ...
                                <div class=" max-w-sm pl-4 pr-4 py-4 bg-white  rounded-lg  ">
                                    ...
                                    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400 text-justify">Go to this
                                        step
                                        by
                                        step guideline
                        ...
                        <div class="md:basis-1/3 pt-24  pr-8">
                            <div class="flex flex-col">
                                ...
                                <div class=" max-w-sm pl-4 py-4 pr-2 bg-white  rounded-lg  ">
                                    ...
                                    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">"Really enjoying all the
                                        ...
                                        Feeling
                                        lucky since I'm pivoting from frontend dev to product design. Cannot wait for more!"
                                    </p>
                                </div>
                            </div>
                        </div>
