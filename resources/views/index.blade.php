...
<section class="overflow-x-hidden" >
    <div class="bg-gradient-to-r from-orange-100 via-gray-100 to-gray-100">
        <div class=" xl:px-20 pt-48 lg:pt-16 md:pt-20 xl:grid xl:grid-cols-2 xl:gap-8 xl:items-center pb-8">
            <div  data-aos="zoom-out-left" data-aos-delay="500" class="px-8 pt-10 xl:pt-12 sm:px-8 xl:px-8 text-center xl:text-left ">
                <div class=" font-semibold text-slate-600 uppercase">
                    <!-- Modal -->
                    <h1 {{App\Helper::test('home.carousel.left.at') }} class=" text-4xl md:text-6xl xl:text-8xl pt-24 md:pt-20  lg:py-0 partie relative " >
                ...
                <div class="py-8 xl:pt-8 md:pt-8">
                    ...
                    <a href="{{ route('login') }} ">
                        <button type="button" style="background-color: #F18700" class=" px-8 py-4 xl:px-16 md:px-12 md:py-2  xl:py-4 uppercase rounded-none font-bold text-white text-center">
            ...
            <div data-aos="zoom-out-right" data-aos-delay="700" class=" bg-no-repeat bg-cover bg-center" style="background-image: url(img/Image9.png);">
                <div
                    ...
                    <span class="absolute flex h-16 w-16">
                        ...
                        <span class="">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="color: white" class="relative inline-flex rounded-full h-12 w-12 pl-1 bg-amber-500">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653z" />
                            </svg>
                        </span>
                    </span>

                    <div {{App\Helper::test('video.home.url') }}  class="partie relative ">
                        <video  autoplay loop muted class="custom-video" poster="videos/792bd98f3e617786c850493560e11c45.png">
                            <source src=" {{asset(__('video.home.url'))}}" type="video/mp4">
...
<div class=" bg-gradient-to-r from-orange-100 from-20%  to-green-100 to-90%">
        ...
        <div class="bg-no-repeat "style="background-image: url(img/background/font_logo.png)">
            ...
            <div class="flex flex-col-reverse sm:flex-row py-4 xl:py-0">
                <div class="sm:w-1/2 text-center sm:text-right sm:pt-4">
                    <a href="/about" {{App\Helper::test('home.button.read_more') }} class=" partie relative inline-flex items-center font-medium text-orange-400 dark:text-orange-400 hover:underline">
    ...
    <div class="xl:flex flex-col xl:flex-row py-10 xl:px-24">
        <div class="xl:w-1/2" data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700">
            ...
            <div {{App\Helper::test('image.home.tech') }} class=" partie relative ">
                <img src="{{asset(__('image.home.tech'))}}" class="h-64 xl:h-80 md:h-72 w-full pr-2 xl:pr-4 pl-2" alt="">
            </div>
        ...
        <div class="xl:w-1/2 py-8 xl:py-0 " data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700">
            ...
            <div  {{App\Helper::test('image.home.smart') }} class="partie relative ">
                <img src="{{asset(__('image.home.smart'))}}" class="h-64 xl:h-80 md:h-72  md:px-3 w-full" alt="">
            </div>
