...
@section('content')
            ...
            <div class="text-center py-16  xl:py-24">
                ...
                <p
                    ...
                    Bienvenue au VITIB - Village des Technologies de l'Information et de la Biotechnologie, un <br
                        class=" md:hidden xl:block"> centre
                    d'excellence dédié à l'innovation et au développement technologique en Côte d'Ivoire. <br
                        class="block md:hidden xl:block"> Situé au cœur de
                ...
                <div class="xl:flex flex-row white xl:absolute  xl:mt-6 left-0 py-6 xl:top-[90%] mt-24 xl:mt-0"
                    ...
                    <div class="xl:w-1/2 xl:pl-32 px-4 xl:pr-8 pt-10">
                        ...
                        <p data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="800"
                            ...
                            Une vision forte serait de promouvoir la collaboration entre les entreprises, les universités,
                            les
                            centres
                        ...
                        <p data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700"
                            ...
                            d'apprentissage
                            continu et en favorisant les interactions entre les étudiants, les chercheurs et les
                            professionnels
                            de
                            l'industrie.
                        </p>
                    ...
                    <div class="xl:w-1/2 xl:pt-56 xl:pl-8 xl:pr-32 px-4 ">
                        ...
                        <p data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700"
                            ...
                            d'innovation en
                            Cote d’Ivoire, peut améliorer la marque et la réputation de votre entreprise. <br> Elle témoigne
                            de
                            votre
    ...
    <div
        ...
        <div class="xl:flex flex-col xl:flex-row py-16 xl:px-24">
            <div class="xl:w-1/2">
                ...
                <p data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700"
                    class="text-justify text-gray-600 pt-4 pl-2 md:pt-4 md:px-4 xl:pr-16">
                ...
                <div data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700" class="pt-8 xl:pt-20">
                    <img src="img/city.png" class="h-64 xl:h-80 md:h-72 w-full pr-2 xl:pr-16 pl-2" alt="">
                </div>
            </div>
            <div class="xl:w-1/2 py-8 xl:py-0">
                <img data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700" src="img/tech.png"
                    class="h-48 xl:h-64 md:h-52  md:px-3 w-full" alt="">
                <h1 data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700"
                    class="font-bold text-3xl  md:px-4 md:text-5xl xl:text-6xl md:text-5xl pt-8 md:pt-16 xl:pt-20">
                    Smart city
                </h1>
                <p data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700"
    ...
    <div class="xl:flex flex-row xl:pl-32 relative px-4 " style="background-image: url(img/blue1.png)">
        ...
        <div class="xl:w-1/2  xl:pr-16 xl:pl-8 xl:pt-16 py-4">
            <div class="xl:sticky xl:top-0"> <!-- Ajoutez ces classes pour rendre le bloc de droite fixe -->
                <p data-aos="zoom-in-left" data-aos-duration="800" data-aos-delay="700"
                    class="text-justify xl:text-lg text-white">
    ...
    <div class="relative xl:flex flex-row bg-gradient-to-r from-gray-100 from-20% to-orange-100 to-90%">
        ...
        <div class="xl:w-3/4 xl:pl-24 md:px-4 md:pb-24 xl:pb-32">
            <h3 data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="500"
                class="font-bold text-4xl xl:text-5xl pl-10 pt-24 pb-8">
                8 avantages unique au Vitib
            </h3>

            <div class="xl:flex flex-row  px-4">
                <div class="w-full xl:w-1/2 xl:pr-10">
                    <h5 data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="600"
                        class="font-bold text-3xl xl:text-3xl pt-8 pb-4">
                    ...
                    <p data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="800"
                        class="text-justify pb-4 xl:text-lg">
                ...
                <div class="w-full xl:w-1/2">
                    <h5 data-aos="zoom-in-right" data-aos-duration="1500" data-aos-delay="300"
                        class=" font-bold text-3md  xl:text-lg xl:pl-10 pt-8 pb-4">
                        Avantages douaniers
                    </h5>
                    ...
                    <div data-aos="zoom-in-right" data-aos-duration="1500"
                        data-aos-delay="500"class="flex flex-row pb-4">
                        <div class="basis-1/6 pl-10">
                            <img src="img/icon/check.png" alt="">
                        </div>
                        <div class="basis-5/6">
                    ...
                    <div data-aos="zoom-in-right" data-aos-duration="1500" data-aos-delay="600"
                        class="flex flex-row pb-4">
                        <div class="basis-1/6 pl-10">
                            <img src="img/icon/check.png" alt="">
                        </div>
                    ...
                    <div data-aos="zoom-in-right" data-aos-duration="1500" data-aos-delay="700"
                        class="flex flex-row pb-4">
                        <div class="basis-1/6 pl-10">
                            <img src="img/icon/check.png" alt="">
                        </div>
                    ...
                    <h5 data-aos="zoom-in-right" data-aos-duration="1500" data-aos-delay="800"
                        class=" font-bold text-3md xl:pl-10 pt-8 pb-4">
                        Infrastructure de pointe
                    </h5>
                    <p data-aos="zoom-in-right" data-aos-duration="1500"
                        data-aos-delay="500"class="text-justify xl:pl-10 pb-4 xl:text-lg">
                    ...
                    <div data-aos="zoom-in-right" data-aos-duration="1500"
                        data-aos-delay="600"class="flex flex-row pb-4">
                        <div class="basis-1/6 pl-10">
                            <img src="img/icon/check.png" alt="">
                        </div>
                        <div class="basis-5/6">
                    ...
                    <div data-aos="zoom-in-right" data-aos-duration="1500"
                        data-aos-delay="800"class="flex flex-row pb-4">
                        <div class="basis-1/6 pl-10">
                            <img src="img/icon/check.png" alt="">
                        </div>
                        <div class="basis-5/6">
                    ...
                    <h5 data-aos="zoom-in-right" data-aos-duration="1500" data-aos-delay="500"
                        class=" font-bold text-3md  pt-8 xl:pl-10 pb-4">
                        Des partenariats et
                        réseautage unique
                    </h5>
                    <p data-aos="zoom-in-right" data-aos-duration="1500" data-aos-delay="600"
                        class="text-justify xl:pl-10 pb-4 xl:text-lg">
        ...
        <div class="xl:w-1/4 xl:pl-64 xl:mt-24 xl:ml-8 bg-no-repeat"
    ...
    <div class="mx-auto px-5 xl:px-20 py-5 bg-gradient-to-r from-orange-100 from-10% via-30% to-green-100 to-90%">
        <div class="text-center xl:px-96  md:px-10">
            ...
            <h1 data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="600"
                class="font-bold text-2xl md:text-3xl xl:text-4xl text-center pb-4">
                Le hub des partenariats stratégiques en Afrique
            </h1>
            <p data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700" class="text-center   xl:text-lg ">
        ...
        <div class="text-center pt-16 xl:pt-48 md:pt-24 xl:mb-8">
            <h1 data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="500"
                class="font-bold text-3xl xl:text-4xl lg:text-5xl text-center pb-4">
                Nos partenaires
            </h1>
            <p data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="600"
                class="text-center  xl:text-lg  md:px-24 xl:px-72 px-4 pb-4">
                Notre mission est soutenue par l'engagement du gouvernement ivoirien, qui favorise activement le
                développement technologique en investissant dans l'innovation et en offrant un soutien précieux aux
                entreprises établies
                dans notre zone.
            </p>
            <div class="flex flex-row">
                <div data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700"
                    class="basis-1/2 xl:text-right">
                    <a href="/partners"
    ...
    <div class=" xl:mx-auto xl:px-36 xl:h-32 ">
        <div class="w-full  items-center">
            <div
                class="flex flex-row justify-center relative overflow-x-auto xl:overflow-x-hidden items-center xl:my-4 my-10">
                <div class="w-1/4 xl:w-1/6 xl:px-auto text-center animate-marquee whitespace-nowrap">
                    <img class="  " style="height: 100px;width:100px" src="img/logo/bidc.png" alt="">
                </div>
                <div class="w-1/4 xl:w-1/6 xl:px-4 pl-4 animate-marquee whitespace-nowrap">
                    <img class=" " src="img/logo/india.png" style="height: 100px;width:100px" alt="">
                </div>
                <div class="w-1/4 xl:w-1/6 pl-4 animate-marquee whitespace-nowrap ">

                    <img class="" src="img/logo/armoirie-Côte-dIvoire.png" style="height: 100px;width:100px"
                        alt="">
                </div>
                <div class="w-1/4 xl:w-1/6 pl-4 animate-marquee whitespace-nowrap ">
                    <img class=" " src="img/logo/boad.png" style="height: 90px;width:100px" alt="">
                </div>
