...
@section('content')
    ...
    <section style="min-height: 1480px;">
        <div class="xl:px-32 xl:px-12 xl:px-4 relative bg-repeat-x" style="background-image: url(img/Image8.png);">
            <div class="xl:flex flex-row  ">
                <div {{App\Helper::test('image.about.dg') }} data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="500" class=" partie relative md:px-8 w-full xl:w-1/2  ">
                    <img src="{{asset(__('image.about.dg'))}}" width="" alt="">
                </div>

                <div data-aos="zoom-in-right" data-aos-duration="800" data-aos-delay="700" class=" md:px-8 xl:w-1/2  mx-4 xl:mr-24">
                    ...
                    <div class="text-justify text-gray-600 xl:text-lg tracking-tight partie relative  " {{App\Helper::test('about.director.message') }} >
                        <span > {!! __('about.director.message') !!} </span>
                    </div>
                ...
                <div class="xl:flex flex-row white xl:absolute  xl:mt-6 left-0 py-6 xl:top-[90%] mt-24 xl:mt-0" style="background-image: url(img/blue.png);">
