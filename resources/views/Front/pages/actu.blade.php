...
@section('content')
    <div class="p-8 md:p-24 bg-gradient-to-r from-orange-100 via-gray-100 to-gray-100">
        ...
        <div data-aos="zoom-in-up" data-aos-duration="700" data-aos-delay="500" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="md:col">
                <div class="md:h-auto md:relative">
                    <div class="md:absolute md:inset-0 rounded-lg"
                    ...
                    <div class="mx-auto max-w-screen-xl text-center md:text-left md:pt-32 lg:pt-32">
                        <p
                            class="text-lg pl-4 md:text-lg lg:text-lg lg:pl-8 lg:pr-4 pb-16 tracking-tight leading-none text-white">
                ...
                <div class="md:h-auto md:relative">
                    ...
                    <div class="text-center md:text-left md:pt-32 lg:pt-32 pb-4">
                        <p
                            class="text-sm pb-16 font-extrabold tracking-tight leading-none text-white md:text-3xl lg:text-lg lg:pl-8 lg:pr-4">
        ...
        <div data-aos="zoom-in-up" data-aos-duration="700" data-aos-delay="500"
            class="md:mx-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-24 ">
