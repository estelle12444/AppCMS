...
<div class="xl:px-20 md:px-0 px-6  bg-no-repeat  bg-gradient-to-r from-orange-100 from-20%  to-gray-100 to-90%">
    <div class="xl:flex flex-col bg-repeat-x" style="background-image: url('img/Image6.png')">
        <div class="  xl:py-8 md:py-8">
            ...
            <div class="xl:flex flex-row py-4 xl:py-8" data-aos="zoom-in-up" data-aos-delay="700" data-aos-delay="700">
                    ...
                    <div class="flex flex-row ml-4 pb-4">
                        ...
                        <div class="xl:w-3/5">
                            <a href="/opportunity-pdf" class="underline hover:underline">
                                <div  {{App\Helper::test('installer.join_us.opportunity_list') }} class=" partie relative xl:text-lg">{!!__('installer.join_us.opportunity_list')!!}</div>
                            </a>
                        </div>
                        <div class="xl:w-1/5">
                            <a href="/opportunity-pdf" class="underline hover:underline">
                    ...
                    <div class="flex flex-row ml-4 pb-4">
                        ...
                        <div class="w-3/5">
                            <a href="/telecharger-pdf" class="underline hover:underline">
                                <div  {{App\Helper::test('installer.join_us.form_pepinier') }} class=" partie relative xl:text-lg">{!!__('installer.join_us.form_pepiniere')!!}</div>
                            </a>
                        </div>
                        <div class="w-1/5">
                            <a href="/telecharger-pdf" class="underline hover:underline">
                    ...
                    <div class=" w-auto mt-4 xl:mt-0   ">
                        <div class="xl:border-dashed px-4 xl:border-l-2 border-gray-700">
                            <div class="pt-2 sm:pt-2 ">
                                <a href="{{ route('login') }} ">
                                    <button type="button" style="background-color: #F18700" {{App\Helper::test('layouts.footer.join_us') }}class=" partie relative font-bold rounded-none text-white text-center  px-8 xl:px-16 md:px-12 md:py-2 py-2 xl:py-4 ">
