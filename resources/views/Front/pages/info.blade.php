    ...
    <div class="  bg-gradient-to-r from-orange-100 from-20%  to-green-100 to-90%">
        <div class="p-5 py-20 mx-2 xl:mx-48">
            <div class="max-w-2xl mx-auto p-6">
                ...
                @else
                    <img src="{{ asset('img/annonce/appel_offre.jpg') }}" alt="News Info" class="w-full h-80 object-cover mb-4 rounded-lg">
                @endif
                <div class="pb-4" style="color: #F18700; position:relative">
                    <p> {!! __('info.job.name') !!} N °{{ $activity->id }}
                    @if(Auth::check() && Auth::user()->role->nom == 'admin')
                                        <span  class="flex items-center" style="width: 60px;right: 0;position: absolute;margin-top:-25px">
                ...
                <h3 class="text-3xl font-bold mb-4 flex items-center"> {{ $activity->translator['title'] }}
