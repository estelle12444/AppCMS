                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img alt="{{ $tender->title }}"
                                                        src="{{ asset('storage/' . $tender->image) }}"
                                                ...
                                                <td><a href="{{ route('Front.admin.tender.edit', $tender) }}"
                                                    ...
                                                    <form action="{{ route('Front.admin.tender.destroy', $tender->id) }}"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                        class="btn btn-danger btn-action trigger--fire-modal-6" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet appel d\'offres?')"><i class="fas fa-trash"></i></button>
