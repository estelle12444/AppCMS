                            ...
                            <form action="{{ route('Front.admin.tender.update', $tender->id) }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea class="form-control" id="description" name="content" rows="3">{{ $tender->content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Documents à joints </label>
                                        <div class="col-sm-12 col-md-7">
                                            <div class="custom-file">
                                                <input type="file" class="form-control-file" id="image"
                                                    name="file">
