                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Modifier l'appel d'offre</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('Front.admin.tender.update', $tender->id) }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input name="title" type="text" id="name" class="form-control"
                                            name="title" value="{{ $tender->title }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Description de
                                        l'appel</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea class="form-control summernote-simple" id="description" name="content" rows="3">{{ $tender->content }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Résumé</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea class="form-control" id="resume" name="resume" rows="3">{{ $tender->resume }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Documents à joints
                                    </label>
                                    <div class="col-sm-12 col-md-7">
                                        <div class="custom-file">
