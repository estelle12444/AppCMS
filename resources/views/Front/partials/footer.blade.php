        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4 md:px-16 py-6 lg:py-8">
            ...
            <div>
                ...
                <ul class="text-gray-700 dark:text-gray-400 font-medium">
                    ...
                    <li class="mb-4">
                        <form action="#" class="flex flex-col items-center md:flex-row">
                            ...
                            <button type="submit" style="background-color: #F18700;"
                                class="pt-3 text-white hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Envoyer</button>
                        </form>
                    </li>
                    <li class="mb-4">
